...
const projects = [
  {
    ...
    liveUrl: "https://sync-flow.netlify.app/",
    gradient: "from-purple-600/20 to-blue-600/20",
    accentColor: "purple",
  },
  {
    name: "Aurum — Restaurant Landing Page",
    tags: ["HTML5", "CSS3", "JavaScript"],
    image: "/projects/aurum.png",
    liveUrl: "https://aurumdines.netlify.app/",
  ...
  },
  {
    ...
    liveUrl: "https://nexushq.netlify.app/",
  ...
  },
  {
    ...
    liveUrl: "https://stridesneakers.netlify.app/",
...
>
  {project.image ? (
    <img
      src={project.image}
      alt={project.name}
      className="w-full h-full object-cover object-[center_80%] sm:object-top transition-transform duration-500 group-hover:scale-105"
    />
  ) : (
    <>
